...
<body>
    ...
    <section id="navigator">
        <div class="container">
            <div class="path">
                ...
                <div class="path-directio" style="color: darkred; display:inline-block;"> /  Hospital</div> 
            </div>
    ...
    <section id="sign-up">
        <div class="container">
                ...
                <form action="addNewHospital.php " method="POST">
                    ...
                    <input type="address" name="address" placeholder="Enter Hospital address" required> 
                    <input type="regNum" name="regNum" placeholder="Enter Registration Number" required> 
                    ...
                    <select name="opStat" id="type" required="">
