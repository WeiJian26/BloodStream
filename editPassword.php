...
if (isset($_POST['submit'])){
    ...
    if(password_verify($currentPw,$row['password'])){
        ...
        if(!isset($error)){
            ...
            $newPw = password_hash($newPw,PASSWORD_BCRYPT,$options);
            $result = mysqli_query($con,"UPDATE users SET password='$newPw' WHERE userID='$userId'");
                if($result){
